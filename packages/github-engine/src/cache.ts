 ...
 * labelled with its last-refresh time" — this is the retention bound that
 * sits underneath `labelWithLastRefresh` in `connectivity.ts`). Least-
 ...
 * is always the first one evicted once the cache is full.
 */
